...
// Cross Module References
	...
	void USimplexNoiseBPLibrary::StaticRegisterNativesUSimplexNoiseBPLibrary()
	{
		...
		static const TNameNativePtrPair<ANSICHAR> AnsiFuncs[] = {
			{ "setNoiseSeed", (Native)&USimplexNoiseBPLibrary::execsetNoiseSeed },
			{ "SimplexNoise1D", (Native)&USimplexNoiseBPLibrary::execSimplexNoise1D },
			{ "SimplexNoise2D", (Native)&USimplexNoiseBPLibrary::execSimplexNoise2D },
			{ "SimplexNoise3D", (Native)&USimplexNoiseBPLibrary::execSimplexNoise3D },
			{ "SimplexNoise4D", (Native)&USimplexNoiseBPLibrary::execSimplexNoise4D },
			{ "SimplexNoiseInRange1D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseInRange1D },
			{ "SimplexNoiseInRange2D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseInRange2D },
			{ "SimplexNoiseInRange3D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseInRange3D },
			{ "SimplexNoiseInRange4D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseInRange4D },
			{ "SimplexNoiseScaled1D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseScaled1D },
			{ "SimplexNoiseScaled2D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseScaled2D },
			{ "SimplexNoiseScaled3D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseScaled3D },
			{ "SimplexNoiseScaled4D", (Native)&USimplexNoiseBPLibrary::execSimplexNoiseScaled4D },
		};
	...
	UClass* Z_Construct_UClass_USimplexNoiseBPLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<USimplexNoiseBPLibrary> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(USimplexNoiseBPLibrary, 1811639558);
	...
	UPackage* Z_Construct_UPackage__Script_SimplexNoise()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/SimplexNoise")), false, false));
